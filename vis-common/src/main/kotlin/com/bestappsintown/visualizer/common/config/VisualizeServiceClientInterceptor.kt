...
class VisualizeServiceClientInterceptor @Autowired constructor(private val applicationContext: ApplicationContext) :
    ...
    override fun preHandle(request: HttpServletRequest, response: HttpServletResponse, handler: Any): Boolean {
        ...
        val request = Request.Builder()
            ...
            .post(jacksonObjectMapper().writeValueAsString(ping).toRequestBody(MEDIA_TYPE_JSON))
            .build()
    ...
    companion object {
        val MEDIA_TYPE_JSON = org.springframework.http.MediaType.APPLICATION_JSON_VALUE.toMediaType()
    }
}
