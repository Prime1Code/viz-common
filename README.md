The project provides all the necessary classes to visualize the request & response streams of a Spring microservice in the `viz-server-app` in a network diagram in real time. 
